...
export default function Experiences() {
  ...
  return (
    <div className="relative bg-white min-h-screen py-16">
  <div className="max-w-7xl mx-auto px-6 flex flex-col gap-12">
    ...
    <div className="flex flex-col items-center justify-center w-full mb-[40px] gap-4">
      ...
      <p className="text-slate-500 text-base font-normal font-['Nunito'] leading-normal text-center max-w-[600px]">
  ...
  <button
    ...
    className={`px-4 py-2 rounded-lg transition-colors ${
      filtro === "All"
        ...
        : "bg-transparent text-slate-500 text-base font-normal font-['Nunito'] leading-none tracking-wide"
    }`}
  >
    All
  </button>
  ...
  {experienciasFiltradas.map((exp) => (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
          ...
          <div className="flex flex-col items-start gap-16 w-full">
            ...
            <div className="flex justify-between items-end w-full">
              <div className="flex flex-col items-start gap-4">
                ...
                <p className="text-[#777E90] font-poppins text-[20px] font-normal leading-[32px] tracking-[-0.2px] w-[544px]">A lot of amazing experiences</p>
              </div>
              {/* Flechas */}
              <div className="flex w-[88px] justify-between items-start">
                <button onClick={prevRec} className="flex p-2 items-center justify-center w-10 h-10 rounded-[40px] border-2 border-[#E6E8EC] bg-white hover:bg-gray-50 transition-colors">
                  {/* Left Arrow SVG */}
                ...
                <button onClick={nextRec} className="flex p-2 items-center justify-center w-10 h-10 rounded-[40px] border-2 border-[#E6E8EC] bg-white hover:bg-gray-50 transition-colors">
                  {/* Right Arrow SVG */}
        ...
        {/* Newsletter + Collage */}
        <div className="w-[1200px] h-[702px] relative bg-white overflow-visible mx-auto mt-32 flex">
{/* Newsletter */}
<div className="w-[548px] flex flex-col justify-center items-start gap-8">
  <div className="flex flex-col gap-4 w-full">
    <div className="text-slate-500 text-xs font-bold font-poppins uppercase">Take A Tour</div>
    <div className="text-teal-600 text-5xl font-bold font-dm-sans leading-[56px]">Join our newsletter</div>
  </div>
  <div className="text-slate-500 text-base font-normal font-poppins">
  ...
  <div className="w-80 h-12 relative rounded-lg outline outline-2 outline-offset-[-2px] outline-teal-600">
    <input
      ...
      className="w-full h-full pl-4 pr-12 text-slate-500 text-sm font-normal font-poppins bg-transparent outline-none placeholder:text-slate-500"
    />
